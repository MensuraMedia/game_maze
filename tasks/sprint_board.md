...
|----|-------|-------|--------|--------|------------|
| T-001 | Write Game Design Document | 02 Game Director | Pending | T-002–T-010 | — |
| T-002 | Create UE5 project from First Person template | 01 Team Lead | Pending | T-003–T-010 | T-001 |
...
| ID | Task | Agent | Status | Blocks | Blocked By |
|----|-------|-------|--------|--------|------------|
| T-011 | Build HUD (timer, score, crosshair) | 11 UI/UX | Pending | T-012 | T-010 |
| T-012 | Implement minimap system | 11 UI/UX | Pending | — | T-003, T-011 |
| T-013 | Create main menu & pause menu | 11 UI/UX | Pending | — | T-010 |
| T-014 | Add ambient audio & sound effects | 10 Audio | Pending | — | T-007 |
| T-015 | Post-processing & visual polish | 09 Lighting | Pending | — | T-007 |
